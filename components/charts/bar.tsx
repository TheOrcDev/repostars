...
const BarInner = memo(function BarInner({
  ...
  return (
    <g className={`bar-series-${uniqueId}`}>
      {data.map(
        // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: registry bar renderer handles vertical, horizontal, stacked, grouped, and perspective variants together.
        (d, i) => {
