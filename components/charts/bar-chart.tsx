...
const ChartCore = memo(function ChartCore({
  ...
  // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: registry chart scale resolution handles stacked and grouped modes together.
  ...
  const handleMouseMove = useCallback(
    // biome-ignore lint/complexity/noExcessiveCognitiveComplexity: registry interaction logic handles horizontal, vertical, stacked, and grouped bars together.
