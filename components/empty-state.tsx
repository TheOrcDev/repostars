...
export function EmptyState({ onAdd, loading }: EmptyStateProps) {
  if (loading) {
    return (
      <div className="flex h-[450px] items-center justify-center rounded-xl border border-dashed bg-muted/30">
        <div className="flex flex-col items-center gap-3 text-muted-foreground">
          <span className="inline-block size-8 animate-spin rounded-full border-2 border-current/30 border-t-current" />
  ...
  return (
    <div className="flex h-[450px] flex-col items-center justify-center gap-8 rounded-xl border border-dashed bg-muted/30 px-4 text-center">
      <div className="flex flex-col items-center gap-4">
        <span className="flex size-12 items-center justify-center rounded-xl border bg-card text-muted-foreground shadow-sm">
