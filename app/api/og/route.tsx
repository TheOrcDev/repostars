      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", zIndex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            ...
            <div style={{ fontSize: 48, fontWeight: 800, color: "#fff" }}>RepoStars</div>
          </div>
          <div style={{ fontSize: 24, opacity: 0.8 }}>repostars.dev</div>
        </div>

        <div style={{ zIndex: 1, marginTop: 18, fontSize: 28, opacity: 0.85 }}>
          Compare GitHub star history with beautiful themed charts
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: 14, marginTop: 38, zIndex: 1 }}>
          {(validRepos.length ? validRepos : [{ fullName: "shadcn-ui/ui", stars: 0 }, { fullName: "47ng/nuqs", stars: 0 }, { fullName: "tailwindlabs/tailwindcss", stars: 0 }]).map((repo, i) => (
            <div
              key={repo.fullName}
              style={{
                display: "flex",
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                />
                <div style={{ fontSize: 28, color: "#fff", fontWeight: 600 }}>{repo.fullName}</div>
              </div>
              <div style={{ fontSize: 28, color: theme.lineColors[i % theme.lineColors.length], fontWeight: 700 }}>
        ...
        <div style={{ zIndex: 1, marginTop: "auto", fontSize: 20, opacity: 0.75 }}>
